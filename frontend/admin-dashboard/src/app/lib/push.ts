...
// Browser Web Push helpers for the admin console. Push requires a secure
// context (https, or localhost in dev) plus Notification + service-worker +
// PushManager support. Mirrors the user dashboard implementation.
