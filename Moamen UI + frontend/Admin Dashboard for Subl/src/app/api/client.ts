...
let _token: string | null = localStorage.getItem("subl_admin_token");

export function setToken(token: string | null) {
  _token = token;
  if (token) localStorage.setItem("subl_admin_token", token);
  else localStorage.removeItem("subl_admin_token");
}
